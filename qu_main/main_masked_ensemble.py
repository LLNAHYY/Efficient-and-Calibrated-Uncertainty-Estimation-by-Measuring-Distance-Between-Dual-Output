...
from uqmodule.masked_ensemble import ResNet18MaskedEnsemble, inference, ood_inference
import argparse
...
def main():
    ...
    if train_true: 
        for seed in args.seeds:#arg
            ...
            model = ResNet18MaskedEnsemble(args.num_classes, args.model_name)
            ...
            logger = TensorBoardLogger(save_dir=save_seed_path, name="resnet18_masked_ensemble")
