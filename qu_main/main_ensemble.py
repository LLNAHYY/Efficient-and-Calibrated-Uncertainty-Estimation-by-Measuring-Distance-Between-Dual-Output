...
from uqmodule.ensemble import ResNet18Ensemble, inference, ood_inference
import argparse
...
def main():
    ...
    if train_true: 
        for seed in args.seeds:#arg
            ...
            model = ResNet18Ensemble(args.num_classes, args.model_name)
            ...
            logger = TensorBoardLogger(save_dir=save_seed_path, name="resnet18_ensemble")
            ...
            #model.model.load_state_dict(torch.load(os.path.join(save_seed_path,f'{qu_method}_{seed}_weights.pth')))
