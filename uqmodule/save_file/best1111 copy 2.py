    ...
    def on_train_end(self):
        ...
        with torch.no_grad():
            for batch in val_loader:
                ...
                #mixed_images, labels_a, labels_b, lam = self.mixup_data(images, labels, alpha=0.5)
        ...
        self.upper_95_percentile = np.quantile(uncertaintys, 0.7)
        upper_50_threshold = np.percentile(uncertaintys, 50)
...
def inference(model, test_loader, threshold,Temperautue):
    ...
    with torch.no_grad():
        ...
        # 모델 예측
            ...
            scaled_logits = torch.clone(class_output1) 
            ...
            uncertainty =  distance1 #calculate_entropy(prob1) #distance1 * calculate_entropy(prob1) #* 100
